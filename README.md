...
However, for datasets acquisition please come talk to me, I have them all in a better format than the published formats. I also have a simple code for a dataloader for each one (PyTorch).
